...
<<<<<<< HEAD
    head = models.ForeignKey('card.Card', related_name='list_in',on_delete=models.SET(None),null=True) # 어차피 head가 지워질일은 리스트 삭제할때밖에 없음.
=======
    head = models.ForeignKey('card.Card', related_name='list_in', on_delete=models.CASCADE,null=True) # 어차피 head가 지워질일은 리스트 삭제할때밖에 없음.
>>>>>>> d6819d17f22d12d793130ef4a8fe89c2e0032bda
